...
class Member extends React.Component {
  ...
  handleSubmitEdit = () => {
    ...
    this.props.form.validateFields((errors, values) => {
      ...
      this.props.userStore.editMember(values).then(data => {
        this.setState({
          submitting: false,
          visEditUser: false,
          members: data.data
      ...
      },
      {
        ...
        render: (text, record) => (
          <div className="m-fun">
            ...
            <Button type="danger" size="small" className="m-blue">
              删除
            </Button>
          </div>
        )
      ...
      <div className="g-content-sub">
        <div className="m-userlist">
          <Button
            ...
            onClick={() => this.setState({ visAddUser: true })}
          >
            <Icon type="user-add" />
            添加用户
          </Button>
              ...
              {getFieldDecorator(
                ...
                <div className="upload-wrap">
                  ...
                  >
                    {image ? (
                      <img
                        src={`${API_STATIC_IMAGE}/${image}.${imageType}`}
                        alt="icon"
                        style={{ maxHeight: 64 }}
                      />
                    ) : (
